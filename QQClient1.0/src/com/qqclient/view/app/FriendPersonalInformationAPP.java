...
public class FriendPersonalInformationAPP extends Application {
    public static Stage friendPersonalInformationStage;
    public static Scene scene;
    @Override
    public void start(Stage primaryStage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/com/qqclient/view/fxml/FriendPersonlInformation.fxml"));//用一个根节点的变量去引用
        scene=new Scene(root,600,338);
        ...
        primaryStage.show();
        friendPersonalInformationStage=primaryStage;
    }
}
