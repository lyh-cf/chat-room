...
public class LookForWordAPP extends Application {
    public static Stage ChangewordStage;
    @Override
    public void start(Stage primaryStage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/com/qqclient/view/fxml/LookingForWord.fxml"));//用一个根节点的变量去引用
