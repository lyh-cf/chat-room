...
public class EditCommonPhrasesAPP extends Application {
    public static Stage EditCommonPhrasesStage;
    @Override
    public void start(Stage primaryStage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/com/qqclient/view/fxml/EditCommonPhrases.fxml"));//用一个根节点的变量去引用
        Scene scene=new Scene(root,490,650);
        ...
        primaryStage.show();
        EditCommonPhrasesStage=primaryStage;
    }
}
