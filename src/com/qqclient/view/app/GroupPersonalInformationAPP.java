...
public class GroupPersonalInformationAPP extends Application {
    public static Stage groupPersonalInformationStage;
    public static Scene scene;
    @Override
    public void start(Stage primaryStage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/com/qqclient/view/fxml/GroupPersonalInformationController.fxml"));//用一个根节点的变量去引用
        scene=new Scene(root,850,618);
        ...
        primaryStage.show();
        groupPersonalInformationStage=primaryStage;
    }
}
