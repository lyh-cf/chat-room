...
public class ChangeMessageAPP extends Application {
    public static Stage ChangeMessageStage;
    public static Scene scene;
    @Override
    public void start(Stage primaryStage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/com/qqclient/view/fxml/ChangeMessage.fxml"));//用一个根节点的变量去引用
        scene=new Scene(root,720,407);
        ...
        primaryStage.show();
        ChangeMessageStage=primaryStage;
    }
}