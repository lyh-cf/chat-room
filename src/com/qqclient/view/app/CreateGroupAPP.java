...
public class CreateGroupAPP extends Application {
    public static Stage CreateGroupStage;
    @Override
    public void start(Stage primaryStage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/com/qqclient/view/fxml/CreateGroupChat.fxml"));//用一个根节点的变量去引用
