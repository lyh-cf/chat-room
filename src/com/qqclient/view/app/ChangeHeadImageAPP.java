...
public class ChangeHeadImageAPP extends Application {
    public static Stage ChangeHeadImageStage;
    @Override
    public void start(Stage primaryStage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/com/qqclient/view/fxml/ChangeHeadImage.fxml"));//用一个根节点的变量去引用
        Scene scene=new Scene(root,686,385);
        ...
        primaryStage.show();
        ChangeHeadImageStage=primaryStage;
    }
}
