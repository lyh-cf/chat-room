...
public class ChangePersonalInformation {
    public static void ChangePersonalInformation(Data data){
        ...
        try {
            ...
            String PersonalizedSignature=user.getPersonalizedSignature();
            String birthday=user.getBirthday();
            String s = "UPDATE `users` SET `idx_name`='" + names + "',`idx_sex`= '" + sex + "',`idx_age`='" + age + "',`idx_birthday`='" + birthday + "',`idx_personalizedsignature`='" + PersonalizedSignature + "'  WHERE `pk_id`='" +userId + "'";
